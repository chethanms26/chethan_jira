...
## 🧑‍💻 Development Team (TOTAL-CODERS)

- [@balachandragouda2-oss](https://github.com/balachandragouda2-oss) - Scrum Master
- [@bdarshan-codes](https://github.com/bdarshan-codes) - Developer Team
- [@chethanms26](https://github.com/chethanms26) - Developer Team
- [@ayush2020-cpu](https://github.com/ayush2020-cpu) - Developer Team
...
1. Clone the repository
   ```bash
   git clone https://github.com/pestechnology/PESU_RR_CSE_C_P30_Online_Marketplace_for_Handcrafted_Goods_TOTAL-CODERS.git
   cd PESU_RR_CSE_C_P30_Online_Marketplace_for_Handcrafted_Goods_TOTAL-CODERS
   ```
...
```
PESU_RR_CSE_C_P30_Online_Marketplace_for_Handcrafted_Goods_TOTAL-CODERS/
├── src/                 # Source code
├── docs/               # Documentation
├── tests/              # Test files
